            ...
            <tr>
                <td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;">
                    <table width="100%" style="border-spacing:0;text-align: left" role="presentation">
                        <tr>
                            <td style="padding-top:22px;padding-right:20px;padding-bottom:5px;padding-left:20px;width:100%;text-align:left;font-size:20px;">
                                <p style=" font-size:20px; font-weight:bold; padding-bottom: 5px;text-align: left">
                                    <strong style="color: #277fd2;">Appointment Confirmation</strong>
                                </p>
                        ...
                        @if($videoConferenceIntegrationEvents->isNotEmpty())
                            <tr>
                                <td style="padding-top:22px;padding-right:20px;padding-left:20px;width:100%;text-align:left;font-size:20px;">
                                    <p style=" font-size:20px; font-weight:bold;text-align: left">
                                        <strong style="color: #277fd2;">Meeting Info</strong>
                                    </p>
                                </td>
                            </tr>
                            @foreach($videoConferenceIntegrationEvents as $event)
                                <tr>
                                    <td style="padding-top:12px;padding-right:20px;padding-bottom:5px;padding-left:20px;width:100%;text-align:left;font-size:20px;">
                                        <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;"><strong>Platform: </strong>{{\App\Models\Integration::PLATFORM_TYPE_NAME_MAPPINGS[$event->integration->platform]}}</p>
                                        <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;"><strong>Link: </strong><a href="{{$event->url}}">{{$event->url}}</a></p>
                                        @if($event->password)
                                            <p style="font-size:15px; line-height: 23px; padding-bottom: 8px;"><strong>Password: </strong>{{$event->password}}</p>
                                        @endif
                                    </td>
                                <tr>
                            @endforeach
