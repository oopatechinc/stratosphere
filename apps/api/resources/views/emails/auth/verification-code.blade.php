                    ...
                    <table width="100%" style="border-spacing:0;text-align: left" role="presentation">
                        <tr>
                            <td style="padding-top:22px;padding-right:15px;padding-bottom:5px;padding-left:15px;width:100%;font-size:20px;">
                                <p style=" font-size:20px; font-weight:bold; padding-bottom: 5px;text-align: left;"><strong style="color: #277fd2;">Your Verification Code!</strong></p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Hi {{ $userName }},</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">You have requested to change your password.</p>
                                <p style="font-size:16px; font-weight: bold; line-height: 23px; padding-bottom: 5px;text-align: left;">Your six digit verification code is: {{ $verificationCode }}</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Enter this code in the provided input box to continue with your password change process.</p>
                            </td>
                        </tr>
                    </table>
                </td>
