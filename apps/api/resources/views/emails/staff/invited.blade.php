...
<center style="width: 100%;table-layout:fixed;background-color: #F6F9FC;padding-bottom: 40px;">
    <div style="max-width: 600px;background-color: #ffffff;box-shadow: 0 0 10px rgba(0, 0, 0, .2);">
        ...
        <div style="font-size: 0px;color: #fafdfe;line-height: 1px;mso-line-height-rule:exactly;display: none;max-width: 0px;max-height: 0px;opacity: 0;overflow: hidden;mso-hide:all;">
            You have an invitation from {{$tenantName}}
        </div>
        ...
        <table align="center" style="border-spacing:0;color:#3D3D3D;font-family: 'Lato',sans-serif, Arial, Helvetica;background-color: #ffffff;Margin:0;padding-top: 0;padding-right: 0;padding-bottom: 0;padding-left: 0;width: 100%;max-width: 600px;" role="presentation">
                    ...
                    <table width="100%" style="border-spacing:0;text-align: left" role="presentation">
                        <tr>
                            <td style="padding-top:22px;padding-right:15px;padding-bottom:5px;padding-left:15px;width:100%;font-size:20px;">
                                <p style=" font-size:20px; font-weight:bold; padding-bottom: 5px;text-align: center;"><strong style="color: #277fd2;">You Are Invited!</strong></p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 10px;">{{$senderName}} from {{$businessName}} has invited you to register as an administrator on {{config('app.name')}}! Please click on the button below to complete your registration.</p>
                                <p style="font-size:16px; font-weight: bold; line-height: 23px; padding-bottom: 5px;text-align: center;">Your invitation code is: {{$invitationCode}}</p>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;">
                    <table width="100%" style="border-spacing:0;" role="presentation">
                        <tr>
                            <td class="padding content" style="background-color:#ffffff;color:#0e0e0e;font-size:16px;padding-top:5px;padding-right:20px;padding-bottom:20px;padding-left:20px;width:100%;text-align:center; width:600px;">
                                <a href="{{$completionUrl}}" target="_blank" style="font-size: 16px;font-weight: bold;text-decoration: none;color: #ffffff;background-color: #277fd2;border:1px solid #277fd2;border-radius:4px;padding:10px 15px;display: inline-block;">Complete Your Registration</a>
                            </td>
                        </tr>
                    </table>
                </td>
