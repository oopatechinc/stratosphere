...
const integration = integrations.value.find(i => i.platform === 'stripe')!
...
async function handleRevoke() {
  ...
  if (error) {
    return displayErrorMessage(t(`app.integrations.${platform}.notifications.revoke_failed`))
  }

  //remove the Zoom platform integrations following revoke
