...
class WebsiteOnboardingController extends Controller
{
    public function store(Request $request)
    {
        ...
        return DB::transaction(function () use ($request) {
            ...
            $domain = Domain::query()->createOrFirst([
            ...
            $staffImage =  $staff->image_url ?? 'https://picsum.photos/300/300';
            ...
            $website = Website::create([
                ...
                'active_config' => [
                    'sections' => [
                        [
                            'id' => 'app_bar',
                            'fields' => ['logo_url' => 'https://picsum.photos/200/50'],
                            'styles' => ['bg_color' => '#000000']
                        ],
                        [
                            'id' => 'hero',
                            'fields' => [
                                ...
                                'name' => $user->full_name,
                                'phone_number' => $user->phone ?? '514.335.4455',
                                'email' => $user->email,
                            ],
                            'styles' => ['bg_color' => '#000000']
                        ],
                        [
                            'id' => 'about_me',
                            'fields' => [
                                'image_url' => $staffImage,
                                'text' => 'Experienced real estate agent with 10 years in the market.'
                            ],
                            ...
                            'fields' => [
                                'items' => [
                                    [
                                        ...
                                        'quote' => 'John found us the perfect home in just a week!'
                                    ],
                                ]
                            ],
                            'styles' => [
