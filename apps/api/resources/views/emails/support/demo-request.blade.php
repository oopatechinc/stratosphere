                    ...
                    <table width="100%" style="border-spacing:0;text-align: left" role="presentation">
                        <tr>
                            <td style="padding-top:22px;padding-right:15px;padding-bottom:5px;padding-left:15px;width:100%;font-size:20px;">
                                <p style=" font-size:20px; font-weight:bold; padding-bottom: 5px;text-align: left;"><strong style="color: #277fd2;">New Demo Request received!</strong></p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Name: {{$name}}</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Email: {{$email}}</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Phone: {{$phone}}</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 5px;text-align: left;">Note: {{$note}}</p>
                        </tr>
                    </table>
                </td>
            </tr>
