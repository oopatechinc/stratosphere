                    ...
                    <table width="100%" style="border-spacing:0;text-align: left" role="presentation">
                        <tr>
                            <td style="padding-top:22px;padding-right:15px;padding-bottom:5px;padding-left:15px;width:100%;font-size:20px;">
                                <p style=" font-size:20px; font-weight:bold; padding-bottom: 5px;text-align: center;"><strong style="color: #277fd2;">Welcome to {{config('app.name')}}!</strong></p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 10px;">Hi {{ $firstname }}, we are glad to have you onboard! Here are some things that you can do:</p>
                                <p style="font-size:15px; line-height: 23px; padding-bottom: 10px;">1. Search and book appointments</p>
                                <p style="font-size:16px; font-weight: bold; line-height: 23px; padding-bottom: 5px;text-align: center;">2. View Your Appointments</p>
                                <p style="font-size:16px; font-weight: bold; line-height: 23px; padding-bottom: 5px;text-align: center;">A messaging platform to facilitate communication</p>
                            </td>
                        </tr>
                    </table>
                </td>
